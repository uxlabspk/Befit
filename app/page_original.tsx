    ...
    <main className="min-h-screen overflow-x-hidden bg-white text-gray-900">
      <section className="relative isolate overflow-hidden border-b border-gray-100">
        ...
        <header className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
          <a href="#top" className="flex items-center gap-3 text-base font-bold tracking-normal text-gray-900">
            <span className="grid h-10 w-10 place-items-center rounded-full border border-gray-300 bg-gray-100 text-gray-700">
              ⚡
            </span>
            BE-FIT
          </a>
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-gray-600 md:flex">
            {["Home", "About", "Gallery", "Store", "Business"].map((item) => (
              <a key={item} href="#" className="transition hover:text-gray-900">
                {item}
              </a>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-3 text-sm font-medium">
            <a href="#pricing" className="rounded-full border border-gray-300 px-4 py-2 text-gray-700 transition hover:border-gray-400 hover:bg-gray-50">
              Login
            </a>
            <a href="#pricing" className="rounded-full bg-gray-900 px-4 py-2 text-white transition hover:bg-gray-800">
              Join now
            </a>
          </div>
        </header>

        <div id="top" className="relative z-10 mx-auto grid w-full max-w-7xl gap-12 px-6 pb-20 pt-12 lg:grid-cols-[1.1fr_0.9fr] lg:px-10 lg:pb-24 lg:pt-16">
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-xs font-medium text-gray-700">
            ...
            <h1 className="max-w-2xl text-4xl font-bold leading-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Push your <span className="text-gray-700">limits.</span>
              <br />
              Track your gains.
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#features"
                className="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3 text-sm font-medium text-gray-700 transition hover:border-gray-400 hover:bg-gray-50"
              >
                Explore programs
              </a>
            </div>
