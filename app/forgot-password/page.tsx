        ...
        <div className="hidden flex-col justify-between bg-gray-950 p-12 text-white lg:flex lg:w-1/2">
          ...
          <div className="max-w-md">
            ...
            <div className="mt-12 space-y-6">
              {[
                { icon: "🔒", title: "Secure reset", desc: "Encrypted password reset links" },
                { icon: "⚡", title: "Instant delivery", desc: "Reset email arrives in seconds" },
                { icon: "🛡️", title: "Protected", desc: "Links expire after 1 hour" },
              ].map((item) => (
                <div key={item.title} className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-gray-800 text-2xl">
                    {item.icon}
                  </div>
                  <div>
